...
Model2 = adaptiveMeasurementSimulation.joinpath('dnm_data')
...
if False:
    # Reads the data
    data = pd.read_csv(Model2.joinpath('varying').joinpath('trajectories_varying_2024_04_18.csv'))
    # Reads the expected counts
    expected = pd.read_csv(Model2.joinpath('varying').joinpath('expected_mus_varying_2024_04_18.csv'))
