...
setup = {
    ...
    'n': 600000,  # No. of ancillary systems
    'theta': 0.2,  # True value of theta for trajectory generation
    'lambda': 0.8,  # Transition parameter, 0<=lmbd<=1
    'phi': pi / 4,  # Phase parameter
    'initial': False,  # Controls initial estimation; eps and gamma are irrelevant if False
    'eps': 0.15,  # Prop. of traj. to use in initial est.
